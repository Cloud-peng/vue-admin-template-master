    ...
    <div class="app-container">
        ...
        <el-table  :data="list"
            ...
            <el-table-column fixed="right" label="操作" width="200" align="center"  >
                <template slot-scope="scope">
                    <el-button  type="primary" size="small" icon="el-icon-star-off" @click="addTofav(scope.row)" >收藏</el-button>
...
import myfavorateApi from '@/api/smq/myfavorate'
import Vue from 'vue';
...
export default {
    ...
    methods: {
        ...
        getList(page = 1) {
            this.page = page
            storageApi.getStorageListPage(this.page, this.limit, this.storageQuery)
                .then(response => {//请求成功
